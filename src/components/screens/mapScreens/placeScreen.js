...
class VoteScreen extends Component {
    ...
    voteUpdate(e,value,vote) {
        this.props.updateVote(this.props.navigation.state.params.item.id ,this.props.navigation.state.params.item.id, value);
    ...
    componentDidMount() {
        ...
        this.setState({positiveVote: this.props.navigation.state.params.item.positiveVotes});
        this.setState({negativeVote: this.props.navigation.state.params.item.negativeVotes});
    }
        ...
        if(this.props.isLoading == true) {
            ...
            return (
                <View style={ styles.container } >
                    ...
                    <Text style= {styles.text }>
                        {this.props.navigation.state.params.item.adresse}, {this.props.navigation.state.params.item.code_postal} {this.props.navigation.state.params.item.ville}
                    </Text>
